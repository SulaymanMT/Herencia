...
public class Taxi extends Vehiculo {
    ...
    public Taxi(String matricula, String marca, String modelo, String color, int numRuedas, int numPuertas, int numPlazas, int Potencia, int capacidadMaletero, Seguro seguro) {
